export const mockStories = [
  ...
  },
  {
    ...
    name: 'story 3',
    story: `
    The teacher asked Jimmy, "Why is your cat at school today Jimmy?".<br/>
    Jimmy replied crying, "Because I heard my daddy tell my mommy, 'I am going to eat that pussy once Jimmy leaves
    for school today!'"`,
  },
  {
    id: 4,
    name: 'story 4',
    story: `
    A housewife, an accountant and a lawyer were asked "How much is 2+2?" <br/>
...
export const actionStory = {
  likeStory: 'This is Funny!',
  dislikeStory: 'This is not funny!',
};

export const warningEmptyStory = `That's all the jokes for today! Come back another day!`;
